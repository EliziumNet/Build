#
# Module manifest for module 'Elizium.Build'
#
...
@{
  ...
  PrivateData       = @{
    ...
    PSData = @{
      ...
      LicenseUri = 'https://github.com/EliziumNet/Build/blob/master/LICENSE'

      # A URL to the main website for this project.
      ProjectUri = 'https://github.com/EliziumNet/Build'
